pacman -Syu --noconfirm alsa-utils bash-completion dmenu fcitx fcitx-configtool fcitx-mozc git i3-wm i3lock i3status jdk-openjdk man network-manager-applet otf-ipafont polkit r ranger scrot sudo unzip vim vlc xfce4-terminal xorg-server xorg-xinit xterm
