pacman -Syu --noconfirm alsa-utils dmenu fcitx fcitx-configtool fcitx-mozc git i3-wm i3lock i3status jdk-openjdk man otf-ipafont sudo vim vlc xfce4-terminal xorg-server xorg-xinit xterm
